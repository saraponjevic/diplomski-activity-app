    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                Text("Meal suggestion: ${recommendation?.nutrition?.mealSuggestion ?: "No data"}")
                Text("Water intake: ${recommendation?.nutrition?.waterIntakeTip ?: "No data"}")
                Text("Nutrition tip: ${recommendation?.nutrition?.nutritionTip ?: "No data"}")
            }
        }
    }
}